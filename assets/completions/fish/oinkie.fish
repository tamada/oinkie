...
complete -c oinkie -n "__fish_oinkie_using_subcommand lift" -l script -d 'Path to a custom lifting script. Interpretation depends on the lifter type. For Ghidra, it\'s the path to a Java script.' -r -F
...
complete -c oinkie -n "__fish_oinkie_using_subcommand extract" -s b -l birthmark-type -d 'Type of birthmark to extract. fc (Function Calls) and op (Opcode) with set, seq, and freq variants are supported. For example, \'op-seq\' extracts the sequence of operations as a birthmark, while \'fc-freq\' extracts the frequency of function calls. The full birthmark types cann be found by running \'oinkie info\'.' -r -f -a "fc-seq\t'the sequence of method calls in a program'
...
op-uni-gram-seq\t'the sequence of 1-grams of operations in a program'
op-bi-gram-seq\t'the sequence of 2-grams of operations in a program'
op-tri-gram-seq\t'the sequence of 3-grams of operations in a program'
op-quad-gram-seq\t'the sequence of 4-grams of operations in a program'
op-penta-gram-seq\t'the sequence of 5-grams of operations in a program'
op-hexa-gram-seq\t'the sequence of 6-grams of operations in a program'
op-hepta-gram-seq\t'the sequence of 7-grams of operations in a program'
op-octa-gram-seq\t'the sequence of 8-grams of operations in a program'
op-uni-gram-freq\t'the frequency of 1-grams of operations in a program'
op-bi-gram-freq\t'the frequency of 2-grams of operations in a program'
op-tri-gram-freq\t'the frequency of 3-grams of operations in a program'
op-quad-gram-freq\t'the frequency of 4-grams of operations in a program'
op-penta-gram-freq\t'the frequency of 5-grams of operations in a program'
op-hexa-gram-freq\t'the frequency of 6-grams of operations in a program'
op-hepta-gram-freq\t'the frequency of 7-grams of operations in a program'
op-octa-gram-freq\t'the frequency of 8-grams of operations in a program'
op-uni-gram-set\t'the set of 1-grams of operations in a program'
op-bi-gram-set\t'the set of 2-grams of operations in a program'
op-tri-gram-set\t'the set of 3-grams of operations in a program'
op-quad-gram-set\t'the set of 4-grams of operations in a program'
op-penta-gram-set\t'the set of 5-grams of operations in a program'
...
op1gram-set-jaccard\t''
op1gram-set-simpson\t''
op1gram-seq-levenshtein\t''
op1gram-seq-lcs\t''
op1gram-freq-cosine\t''
op1gram-freq-euclidean\t''
op1gram-freq-weightedjaccard\t''
op2gram-set-dice\t''
op2gram-set-jaccard\t''
op2gram-set-simpson\t''
op2gram-seq-levenshtein\t''
op2gram-seq-lcs\t''
op2gram-freq-cosine\t''
op2gram-freq-euclidean\t''
op2gram-freq-weightedjaccard\t''
op3gram-set-dice\t''
op3gram-set-jaccard\t''
op3gram-set-simpson\t''
op3gram-seq-levenshtein\t''
op3gram-seq-lcs\t''
op3gram-freq-cosine\t''
op3gram-freq-euclidean\t''
op3gram-freq-weightedjaccard\t''
op4gram-set-dice\t''
op4gram-set-jaccard\t''
op4gram-set-simpson\t''
op4gram-seq-levenshtein\t''
op4gram-seq-lcs\t''
op4gram-freq-cosine\t''
op4gram-freq-euclidean\t''
op4gram-freq-weightedjaccard\t''
op5gram-set-dice\t''
op5gram-set-jaccard\t''
op5gram-set-simpson\t''
op5gram-seq-levenshtein\t''
op5gram-seq-lcs\t''
op5gram-freq-cosine\t''
op5gram-freq-euclidean\t''
op5gram-freq-weightedjaccard\t''
op6gram-set-dice\t''
op6gram-set-jaccard\t''
op6gram-set-simpson\t''
op6gram-seq-levenshtein\t''
op6gram-seq-lcs\t''
op6gram-freq-cosine\t''
op6gram-freq-euclidean\t''
op6gram-freq-weightedjaccard\t''"
