...
- Both container images build again, and something checks that they can. #91
  ...
  to run it; `.github/scripts/check_container_sources.sh` stands in for the
  full image, which is not built until a release because what it adds is a
  400 MB Ghidra download
