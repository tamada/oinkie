...
8. **Design and Evaluation of Birthmarks for Detecting Theft of Java Programs**, *Haruaki Tamada, Masahide Nakamura, Akito Monden, and Kenichi Matsumoto*, In Proc. IASTED International Conference on Software Engineering (IASTED SE 2004), pp. 569--575, February 2004 (Innsbruck, Austria). [ [Link](https://www.academia.edu/4149089/Design_and_evaluation_of_birthmarks_for_detecting_theft_of_java_programs) ]
